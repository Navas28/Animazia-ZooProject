            ...
            <div className="flex flex-col md:flex-row items-start justify-between w-full gap-8">
                ...
                <div className="md:w-1/2 p-4" data-aos="fade-down">
                    <p className="text-customeWhite font-para text-lg">
                        At <span className="text-lightOrange">Animazia</span> , our goal is to inspire and educate visitors about wildlife. We focus on conservation
                    ...
                    <div>
                        <div class="max-w-5xl px-4 xl:px-0 py-10 mx-auto ">
                            <div class="border border-neutral-800 rounded-xl">
                                <div class="p-4 lg:p-8 bg-mediumGreen rounded-xl">
                                    <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                                        <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                            <svg
                                                class="shrink-0 size-6 sm:size-12 text-[#ff0] mx-auto"
                                            ...
                                            <div class="mt-3 sm:mt-5">
                                                <h3 class="text-lg sm:text-3xl font-semibold text-white font-subhead">
                                                    2,000+
                                                </h3>
                                                <p class="mt-1 text-sm sm:text-base text-neutral-400 font-para">Animals</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                            <div class="flex justify-center items-center -space-x-5">
                                                <svg
                                                    class="shrink-0 size-6 sm:size-11 text-[#ff0] mx-auto"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                                    height="24"
                                                    viewBox="0 0 24 24"
                                            ...
                                            <div class="mt-3 sm:mt-5">
                                                ...
                                                <p class="mt-1 text-sm sm:text-base text-neutral-400 font-para">
